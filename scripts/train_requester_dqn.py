...
def main() -> None:
    ...
    parser.add_argument("--log-dir", default="runs/requester")
    ...
    # 请求者侧：anchor=项目，candidate=worker
    dqn_cfg = DQNConfig(
    ...
    logger = TrainingLogger(log_dir=Path(args.log_dir), run_name="requester_dqn")
    logger.save_config(
        {
            "side": "requester",
            "dataset": ds.summary(),
